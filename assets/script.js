...
$(function () {
  ...
  duplicateRows(); //calling the function that makes all the rows
...
let duplicateRows = function () {
  for (let i = 0; i < 8; i++) {
    ...
    let scheduleTime = 9 + i; //setting the work day from 9am
    let time = document.getElementById(i).children[0];
    time.textContent = (dayjs().set("hour", scheduleTime).format("ha"));
  }
}
